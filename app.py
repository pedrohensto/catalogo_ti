...
class App:
    ...
    def montar_formulario(self):
        ...
        self.campo_tipo_documento = ttk.Combobox(self.frame_form, values=["CPF", "CNPJ"])
        ...
        # listar
        self.botao_listar = tk.Button(self.frame_form, text="Listar", command=self.listar)
        self.botao_listar.grid(row=14, column=0, columnspan=2)
        # limpar
        self.botao_limpar = tk.Button(self.frame_form, text="Limpar", command=self.limpar)
        self.botao_limpar.grid(row=15, column=0, columnspan=2)
        # voltar
    ...
    def preparar_formulario(self, prestador):
        if prestador is None:
            ...
            self.campo_tipo_documento.insert(0, prestador.tipo_documento)
            ...
            self.campo_uf.insert(0, prestador.uf)
    ...
    def salvar(self):
        ...
        if self.id_em_edicao is None:
            ...
            prestador.updatePrestador()
    def excluir(self):
        if self.id_em_edicao is None:
            return
        prestador = Prestador(id=self.id_em_edicao)
        prestador.deletePrestador()
    def listar(self):
    ...
    def limpar(self):
        ...
        self.campo_tipo_documento.delete(0, tk.END)
